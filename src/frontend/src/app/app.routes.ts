...
import { PurchaseOrdersPageComponent } from './features/purchase-orders/purchase-orders-page.component';
		...
		children: [
			{
				...
				loadChildren: () => import('./features/dashboard/dashboard.routes')
					.then((module) => module.dashboardRoutes)
			},
			{
				path: 'categories',
			...
			},
			{
				...
				data: {
					title: 'Purchase Orders | Inventory Management System',
					description: 'Review supplier purchase orders and fulfilment status.'
				}
			},
			{
				path: 'audit-logs',
				...
				data: {
					...
					title: 'Audit Logs | Inventory Management System',
					description: 'Review authentication and inventory change history.'
				}
			},
			{
				path: 'admin/users',
